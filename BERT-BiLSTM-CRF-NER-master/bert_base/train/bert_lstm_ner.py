    ...
    def get_labels(self, labels=None):
        ...
        if os.path.exists(os.path.join(self.output_dir, 'label_list.pkl')):
            ...
            if len(self.labels) > 0:
                ...
                self.labels = ["O", 'B-PRO', 'I-PRO', "B-PER", "I-PER", "B-ORG", "I-ORG", "B-LOC", "I-LOC", "X", "[CLS]", "[SEP]"]
        return self.labels
...
if os.name == 'nt': #windows path config
   bert_path = r'E:\bert\chinese_L-12_H-768_A-12'
   root_path = r'E:\bert\BERT-BiLSTM-CRF-NER-master\BERT-BiLSTM-CRF-NER-master'
